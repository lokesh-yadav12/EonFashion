    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
          ...
          <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
            ...
            <p>jsdfh hisohf g gfig ssdigff figifg fsdif gfgyufg fgfyg fyugfyu gfygf fgfg g78eiu rwirywer ywuiagfu gsdfysdu ifysduk gfgfsdyutf uifgsduifguifts fgyj</p>
            <b className='text-gray-800'>Our Mission</b>
            <p>jow hterioh puig ruiygsuifgsui sgsgigfuhshdsif digi gf gueg hisdg gig s ofyowe hoyr wfgiti gitriwywo ruiwetrwi it hs h jow hterioh puig ruiygsuifgsui sgsgigfuhshdsif digi gf gueg hisdg gig s ofyowe hoyr wfgiti gitriwywo ruiwetrwi it hs h </p>
          </div>
      </div>
